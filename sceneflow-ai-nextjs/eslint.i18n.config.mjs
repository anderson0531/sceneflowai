...
const eslintConfig = [
  {
    files: [
      ...
      'src/components/blueprint/BlueprintListenButton.tsx',
      'src/components/blueprint/BlueprintExportDialog.tsx',
      'src/components/blueprint/BlueprintNarrationSection.tsx',
      'src/components/blueprint/BlueprintTtsControls.tsx',
