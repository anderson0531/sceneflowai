...
describe('Hero video locales', () => {
  ...
  it('plays English, Spanish, Portuguese, Hindi, and Chinese Blob masters with other dubs marked Soon', () => {
    ...
    expect(available).toEqual(['en', 'es', 'pt', 'hi', 'zh'])
    expect(placeholders).toEqual(['ar', 'th'])
