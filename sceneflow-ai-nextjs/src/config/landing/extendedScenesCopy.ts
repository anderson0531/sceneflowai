...
export const EXTENDED_SCENES_COPY = {
  ...
  subtitle:
    'Break past the single-clip wall—approve the look first, then extend your scene step by step into seamless monologues, explainers, and dialogue beats.',
  intro:
    'SceneFlow does not promise one unlimited render. It plans long beats as ordered sequences: an initial clip up to 8 seconds, then continuous +7 second extension steps—with beat-first approval before you spend credits.',
  steps: [
    {
    ...
    },
    {
      ...
      description: 'Each step continues the same angle and motion—ideal for uninterrupted dialogue within a beat.',
    },
    {
