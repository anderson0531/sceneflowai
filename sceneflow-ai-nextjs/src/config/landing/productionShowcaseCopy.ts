...
export const PRODUCTION_SHOWCASE_COPY = {
  ...
  subtitle:
    'Walk one complete production through the three review surfaces producers share: Blueprint Audience Resonance, Script Audience Resonance, then the Screening Room. Read and listen — no account, no feedback.',
  ...
  explorePipelineCta: 'Walk the review pipeline',
  explorePipelineHint:
    'Read and listen only. No account. No feedback. Same surfaces producers share with stakeholders.',
  pipelineOpenLabel: 'Open',
  pipelineComingSoon: 'Demo link coming soon',
  moreProductionsLabel: 'More productions',
  moreProductionsHint:
    'Compare Screening Room masters across drama, animation, documentary, and localized versions.',
  pipelineSteps: [
    {
      id: 'blueprint',
      step: '1',
      title: 'Blueprint + Audience Resonance',
      body: 'Read the treatment and hear section narration. See how Audience Resonance scores concept, tone, characters, and beats before anyone spends on renders.',
    },
    {
      id: 'script-ar',
      step: '2',
    ...
    },
    {
      ...
      body: 'Watch the assembled production. Switch Pre-Vis, scenes, and final, then pick a language to hear the dub. Viewing only — no ratings or emoji.',
    },
  ],
