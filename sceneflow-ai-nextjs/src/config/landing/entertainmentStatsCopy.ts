...
export const ENTERTAINMENT_STATS_COPY = {
  ...
  footnote: 'Sources: Nielsen, Digital i (industry reports). Market context—not SceneFlow performance data.',
  stats: [
    { value: '13.4%', label: 'YouTube share of U.S. TV viewing' },
    { value: '8.8%', label: 'Netflix share (context)' },
    { value: '99.1 min', label: 'Avg. daily YouTube per account (global)' },
    { value: '35%+', label: 'YouTube watch time on connected TV' },
  ],
} as const
