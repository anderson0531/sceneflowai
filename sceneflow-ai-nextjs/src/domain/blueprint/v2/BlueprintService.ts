...
import { BLUEPRINT_NAMING_REQUIREMENTS } from '@/lib/character/characterNamingPrompt'
...

{
  ...
  "treatment"?: {
    ...
    "character_breakdown": {
      "main": [{ "name": string (CRITICAL: Full name in Title Case, original and culturally authentic), "role": string, "description": string, "motivations"?: string[], "arc"?: string, "concrete_details"?: string[] }],
