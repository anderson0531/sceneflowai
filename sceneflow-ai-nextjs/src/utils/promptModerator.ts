...
export const TRIGGER_WORD_ALTERNATIVES: Record<string, string[]> = {
  ...
  // Sci-fi / action / cinematic terms that trigger DANGEROUS_CONTENT classifier
  // These are common in cinematic prompts but flagged by Vertex AI's enterprise classifier
  'explosive': ['radiant', 'dynamic', 'shattering', 'bursting'],
  'explodes': ['emanates violently', 'irradiates', 'flares outward', 'cascades'],
  'explode': ['emanate', 'irradiate', 'flare outward', 'cascade'],
  'exploding': ['emanating', 'irradiating', 'flaring', 'cascading'],
  'explosion': ['radiant burst', 'energy release', 'luminous cascade', 'shockwave'],
  'explosions': ['radiant bursts', 'energy releases', 'luminous cascades', 'shockwaves'],
  'detonation': ['energy release', 'luminous burst', 'shockwave'],
  'detonate': ['release energy', 'burst', 'cascade'],
  'detonates': ['releases energy', 'bursts outward', 'cascades'],
  'bomb': ['device', 'object', 'mechanism'],
  'bombing': ['impact', 'strike', 'event'],
  'grenade': ['projectile', 'object', 'device'],
  'missile': ['projectile', 'object', 'streaking light'],
  'blast': ['surge', 'wave', 'burst', 'pulse'],
  'blasts': ['surges', 'waves', 'bursts', 'pulses'],
  'singularity': ['point of origin', 'infinite core', 'focal nexus', 'convergence point'],
  'nuclear': ['cosmic', 'immense', 'cataclysmic', 'overwhelming'],
  'radioactive': ['glowing', 'luminescent', 'energized', 'radiant'],
  'radiation': ['energy', 'luminance', 'radiance', 'emanation'],
  'toxic': ['hazardous', 'volatile', 'intense', 'acrid'],
  'poison': ['substance', 'compound', 'element'],
  'poisonous': ['dangerous', 'volatile', 'hazardous'],
  'lethal': ['devastating', 'overwhelming', 'critical'],
  'fatal': ['critical', 'decisive', 'final'],
  'shrapnel': ['debris', 'fragments', 'particles', 'splinters'],
  'gunfire': ['flashes of light', 'rapid bursts', 'staccato flashes'],
  'gunshot': ['sharp crack', 'sudden flash', 'report'],
  'bullet': ['projectile', 'streak', 'flash'],
  'bullets': ['projectiles', 'streaks', 'flashes'],
  'shooting': ['firing', 'directing', 'aiming'],
  'combat': ['conflict', 'confrontation', 'clash'],
  'warfare': ['conflict', 'struggle', 'engagement'],
  'battlefield': ['arena', 'landscape', 'terrain'],
  'carnage': ['chaos', 'destruction', 'devastation'],
  'destruction': ['transformation', 'disintegration', 'shattering'],
  'destructive': ['transformative', 'overwhelming', 'powerful'],
  'annihilate': ['overwhelm', 'consume', 'engulf'],
  'annihilation': ['overwhelming force', 'total transformation', 'engulfment'],
  'obliterate': ['overwhelm', 'consume', 'dissolve'],
  'devastation': ['transformation', 'upheaval', 'cataclysm'],
  'catastrophe': ['cataclysm', 'upheaval', 'dramatic event'],
  'catastrophic': ['cataclysmic', 'dramatic', 'monumental'],
  'apocalyptic': ['monumental', 'epochal', 'world-altering'],
  'apocalypse': ['cataclysm', 'dramatic transformation', 'epochal event'],
  'inferno': ['blazing light', 'fierce glow', 'radiant intensity'],
  'hellfire': ['blazing light', 'fierce radiance', 'intense glow'],
  'ablaze': ['illuminated', 'radiant', 'aglow'],
  'incinerate': ['consume in light', 'dissolve', 'engulf'],
};
...
const TRIGGER_PHRASES: Record<string, string> = {
  ...
  // Sci-fi / action phrases (trigger DANGEROUS_CONTENT classifier)
  'explosive wide shot': 'panoramic burst shot',
  'explosive wide angle': 'radiant wide angle',
  'explodes outward': 'flares outward',
  'explodes into': 'cascades into',
  'explodes from': 'emanates from',
  'exploding outward': 'cascading outward',
  'energy explodes': 'energy cascades',
  'light explodes': 'light cascades',
  'singularity point': 'focal nexus',
  'nuclear blast': 'cosmic surge',
  'nuclear explosion': 'cosmic radiance burst',
  'massive explosion': 'massive energy cascade',
  'fiery explosion': 'luminous cascade',
  'chain of explosions': 'chain of radiant bursts',
  'ball of fire': 'sphere of radiant light',
  'engulfed in flames': 'engulfed in radiant light',
  'consumed by fire': 'consumed by radiant energy',
  'wall of fire': 'wall of radiant energy',
  'rain of fire': 'cascade of radiant light',
  'sea of flames': 'sea of luminous energy',
};
