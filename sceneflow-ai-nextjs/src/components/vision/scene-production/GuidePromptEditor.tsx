          ...
          <div className="p-4 space-y-4 bg-slate-900/50">
            {segment.dialogueLineIds && segment.dialogueLineIds.length > 0 && (
              <div className="flex gap-2 p-3 rounded-lg bg-cyan-950/40 border border-cyan-700/40 text-xs text-cyan-100/90 leading-snug">
                ...
                <span>
                  Dialogue lines come from <span className="font-medium text-cyan-200">shot assignment</span> (Call Action / beat builder). Adjust assignments there to change which lines appear. Use portion sliders below only when one assigned line is longer than a single clip.
                </span>
              </div>
            )}
