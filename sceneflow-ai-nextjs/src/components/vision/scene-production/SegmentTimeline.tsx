...
export function SegmentTimeline({ segments, selectedSegmentId, onSelect, audioTracks }: SegmentTimelineProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="overflow-x-auto border border-gray-200 dark:border-gray-800 rounded-lg bg-gray-50 dark:bg-gray-900">
        <div style={{ width: `${Math.max(timelineWidth, 800)}px`, minHeight: '200px' }} className="relative">
