      ...
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {frameType === 'both' ? t('titlePlural') : t('title')}
            <Badge variant="outline" className="ml-2 text-xs">
              {t('beatBadge', { number: segmentIndex + 1 })}
            </Badge>
            <Badge 
              variant="secondary" 
              className={cn(
            ...
            >
              {frameType === 'both' ? t('startEnd') : frameType === 'start' ? t('startFrame') : t('endFrame')}
            </Badge>
          </DialogTitle>
          {isEndInvolved && (
            ...
            <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg flex-shrink-0">
              <div className="flex items-start gap-2">
                ...
                <div className="text-xs text-blue-300">
                  <p className="font-medium mb-1">{t('characterRefsActive')}</p>
            ...
            <div className="mt-4 p-3 bg-purple-500/10 border border-purple-500/30 rounded-lg flex-shrink-0">
              <div className="flex items-start gap-2">
                ...
                <div className="text-xs text-purple-300">
                  <p className="font-medium mb-1">{t('contentAwareEnd')}</p>
                  <p className="text-purple-400/80">
                    {t('contentAwareEndHint')}
                  </p>
                </div>
              </div>
            </div>
