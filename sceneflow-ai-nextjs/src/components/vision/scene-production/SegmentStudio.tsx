...
import { Upload, Video, Image as ImageIcon, CheckCircle2, Link as LinkIcon, Sparkles, Loader2, Info, Film, Play, X, Maximize2, ChevronDown } from 'lucide-react'
