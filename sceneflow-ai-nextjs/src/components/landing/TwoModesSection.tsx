      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <motion.article
            ...
            className="flex h-full flex-col rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-950/40 to-slate-900/80 p-6 sm:p-8"
          >
          ...
          <motion.article
            ...
            className="flex h-full flex-col rounded-2xl border border-indigo-500/20 bg-gradient-to-br from-indigo-950/40 to-slate-900/80 p-6 sm:p-8"
          >
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-3 py-1.5">
              <Clapperboard className="h-4 w-4 text-indigo-400" />
              <span className="text-sm font-medium text-indigo-300">
                {t('director.name')} · {t('director.subtitle')}
              </span>
            </div>
            <p className="mb-6 text-lg font-semibold text-indigo-100">{t('director.tagline')}</p>
            <ul className="mb-8 flex-1 space-y-3">
            ...
            <Button
              size="lg"
              variant="outline"
              className="w-full border-indigo-500/40 text-indigo-200 hover:bg-indigo-500/10"
              onClick={scrollToCheckout}
            >
              {t('director.cta')}
              <ArrowRight className="ml-2 h-5 w-5" />
