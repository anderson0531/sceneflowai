...
export function PricingTierGrid({
  ...
  const t = useTranslations('pricing.tierGrid')
      ...
      <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
        {basePlans.map((plan, index) => {
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              <div className="p-3 rounded-lg bg-gray-800/50 border border-gray-700/50">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs text-gray-400">{t('creditsPerMonth')}</span>
                </div>
              ...
              <div className="p-3 rounded-lg bg-gray-800/50 border border-gray-700/50">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs text-gray-400">{t('storage')}</span>
                </div>
            ...
            >
              {loadingTier === plan.id ? t('loading') : t('getStarted')}
