...
const modules = [
  {
    ...
    ecosystemDetail: 'The characters, voices, and locations saved in your Reference Library flow directly into the Visualizer and Smart Editor, ensuring your cast looks and sounds identical in every scene.',
