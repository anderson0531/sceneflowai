          ...
          <Tabs defaultValue="beat-sheet" className="w-full h-full flex flex-col">
            <div className="border-b border-gray-700">
              <TabsList className="flex w-full bg-transparent m-0 p-0 h-auto">
                <TabsTrigger value="treatment" className="flex-1 h-12 px-4 text-sm font-medium text-gray-300 border-b-4 border-transparent hover:text-white hover:border-gray-500 data-[state=active]:text-white data-[state=active]:font-semibold data-[state=active]:border-blue-500 bg-transparent rounded-none transition-all duration-200">Film Treatment</TabsTrigger>
                <TabsTrigger value="characters" className="flex-1 h-12 px-4 text-sm font-medium text-gray-300 border-b-4 border-transparent hover:text-white hover:border-gray-500 data-[state=active]:text-white data-[state=active]:font-semibold data-[state=active]:border-blue-500 bg-transparent rounded-none transition-all duration-200">Character Breakdowns</TabsTrigger>
                <TabsTrigger value="beat-sheet" className="flex-1 h-12 px-4 text-sm font-medium text-gray-300 border-b-4 border-transparent hover:text-white hover:border-gray-500 data-[state=active]:text-white data-[state=active]:font-semibold data-[state=active]:border-blue-500 bg-transparent rounded-none transition-all duration-200">Interactive Beat Sheet</TabsTrigger>
                <TabsTrigger value="series-bible" className="flex-1 h-12 px-4 text-sm font-medium text-gray-300 border-b-4 border-transparent hover:text-white hover:border-gray-500 data-[state=active]:text-white data-[state=active]:font-semibold data-[state=active]:border-blue-500 bg-transparent rounded-none transition-all duration-200">Series Bible</TabsTrigger>
              </TabsList>
            </div>
