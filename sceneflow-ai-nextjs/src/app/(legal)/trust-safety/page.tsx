...
import { Shield, Mic, FileSearch, Users, Fingerprint } from 'lucide-react'
import {
  LEGAL_ABUSE_EMAIL,
  LEGAL_ADDRESS,
  LEGAL_COMPANY_NAME,
...
export const metadata: Metadata = buildLegalMetadata(getLegalPageById('trust-safety'))
        ...
        <div className="prose prose-invert prose-purple max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              {LEGAL_COMPANY_NAME} operates {LEGAL_SERVICE_NAME} with shared responsibility alongside {WHOP_MOR_NAME}, our Merchant of Record. Google provides provider-scale safety on generation; {LEGAL_SERVICE_NAME} adds platform guardrails, content validation, provenance logging, violation strikes, account suspension, and abuse reporting.
            </p>
            <ul className="list-disc pl-6 text-gray-300 space-y-2">
              ...
              <li><strong>Abuse reporting:</strong> Report concerns to {LEGAL_ABUSE_EMAIL} — investigated within 24 hours</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              You may appeal a suspension by emailing {LEGAL_ABUSE_EMAIL} within seven (7) days of notice. Reinstatement is not guaranteed. See our Terms of Service Section 12.2 for user liability and indemnification obligations.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              If you encounter content generated by {LEGAL_SERVICE_NAME} that you believe violates our policies or is being used for malicious purposes, please report it immediately:
            </p>
            <ul className="list-disc pl-6 text-gray-300 space-y-2">
              <li><strong>Email:</strong> {LEGAL_ABUSE_EMAIL}</li>
          ...
          <section>
            ...
            <p className="text-gray-300">
              ...
              {LEGAL_ADDRESS}<br />
              <strong>Trust & Safety:</strong> {LEGAL_TRUST_EMAIL}<br />
              <strong>Abuse Reports:</strong> {LEGAL_ABUSE_EMAIL}<br />
              <strong>Legal Inquiries:</strong> {LEGAL_LEGAL_EMAIL}<br />
