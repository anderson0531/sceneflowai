...
export const metadata: Metadata = buildLegalMetadata(getLegalPageById('privacy'))
        ...
        <div className="prose prose-invert prose-purple max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
              ...
              <li><strong>Payment Information:</strong> Processed securely by Whop, our Merchant of Record; we do not store credit card numbers</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-300 space-y-2">
              ...
              <li><strong>Infrastructure Providers:</strong> Vercel, Google Cloud SQL — for hosting and database services</li>
