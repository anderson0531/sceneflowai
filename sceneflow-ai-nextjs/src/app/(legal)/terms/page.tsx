...
export const metadata: Metadata = buildLegalMetadata(getLegalPageById('terms'))
    ...
    <>
        ...
        <div className="prose prose-invert prose-purple max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              SceneFlow Studio is an AI-powered filmmaking platform that enables users to create video content including scripts, pre-visualization, voice synthesis, and video generation. The Service uses artificial intelligence technologies from third-party providers including Google (Gemini, Imagen, Veo), and ElevenLabs.
            </p>
          </section>
