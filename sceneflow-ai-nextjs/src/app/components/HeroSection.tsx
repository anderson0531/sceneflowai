      ...
      <section className="relative bg-gray-950 text-white pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-28 lg:pb-24">
        ...
        <div className="relative container mx-auto px-4 z-10">
          ...
          <div className="max-w-4xl mx-auto text-center mt-12 lg:mt-14">
            ...
            >
              <p className="max-w-3xl text-[11px] font-semibold uppercase tracking-[0.22em] text-cyan-300/90">
                {t('eyebrow')}
              </p>
              <span className="inline-flex items-center justify-center gap-2 rounded-full border border-amber-400/30 bg-amber-400/10 px-3 py-1 text-xs font-semibold text-amber-200">
