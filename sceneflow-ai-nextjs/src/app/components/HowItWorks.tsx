  ...
  const steps = [
    {
      ...
      description: 'Transform a single idea into a multi-episode franchise. The Series Studio manages long-form narrative arcs and maintains total visual continuity across up to 40 episodes with a shared Reference Library.',
    ...
    },
    {
      ...
      description: 'Reference Library locks character, wardrobe, and location references for frame-perfect consistency. 800+ premium voices with cloning. Imagen 3 storyboards flow to Veo 3.1 video—each frame AI-generated, each cut director-approved.',
