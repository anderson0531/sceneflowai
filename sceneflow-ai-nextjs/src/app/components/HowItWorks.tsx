...
export function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: 'Transform your treatment into a full script with AI-generated storyboards. Render scenes with Veo 3.1 and review in the Screening Room. Premium ElevenLabs audio with multi-language support. Export in industry-standard formats.',
    ...
    },
    {
      ...
      description: 'Expand your audience with multi-language voice dubbing. Add transitions, preview your complete video in the Screening Room, and export as MP4 or MOV.',
