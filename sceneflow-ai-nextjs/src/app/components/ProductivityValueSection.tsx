    ...
    >
      ...
      <div className="bg-emerald-500/5 rounded-2xl p-6 border border-emerald-500/20 relative">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <h4 className="text-lg font-bold text-white" translate="no">SceneFlow Studio</h4>
        </div>
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-emerald-500/5 rounded-2xl p-6 border border-emerald-500/20">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="text-lg font-bold text-white" translate="no">SceneFlow Studio Co-Pilot</h4>
          </div>
      ...
      <div className="text-center mt-8 p-4 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-xl border border-cyan-500/20">
        ...
        <p className="text-white font-medium">
          <span translate="no">SceneFlow Studio</span> bridges the expertise gap
        </p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Beyond cost savings—see how <span translate="no">SceneFlow Studio</span> saves time and eliminates the expertise gap
          </p>
        </motion.div>
