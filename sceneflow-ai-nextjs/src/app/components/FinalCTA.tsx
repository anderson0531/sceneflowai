      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-12 leading-relaxed">
            Join thousands of creators who are already using SceneFlow AI to produce professional videos in minutes, not days. Start your journey today with our risk-free trial.
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <button
              onClick={scrollToPricing}
              className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white text-xl px-12 py-6 rounded-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
            >
              Choose Your Plan
            </button>
          ...
          >
            <p className="text-gray-300 text-sm leading-relaxed">
              <strong>Why $5?</strong> Our professional-grade AI visualization requires significant GPU power and dedicated resources. This small investment ensures you get the same high-speed, reliable access that our paying customers enjoy. Think of it as the price of a latte for access to premium creative tools that can transform your entire workflow.
            </p>
          </motion.div>
        </motion.div>
      </div>
