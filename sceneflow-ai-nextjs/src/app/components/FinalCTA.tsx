        ...
        >
          ...
          >
            <p className="text-gray-300 text-sm leading-relaxed">
              <strong className="text-white">Why $9?</strong> SceneFlow uses cutting-edge AI models like Gemini 3.0 Pro, Veo 3.1, and ElevenLabs which require significant computational resources. This small investment ensures you get reliable, high-speed access to the same professional tools our subscribers use—about the cost of two coffees.
            </p>
          </motion.div>
        </motion.div>
      </div>
