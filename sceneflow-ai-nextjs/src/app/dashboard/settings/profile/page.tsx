          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-purple-800">1500 Credits</span>
              </div>
              <p className="text-xs text-purple-600 mt-1">Available for video generation</p>
            </div>
          </div>
        </div>
      </motion.div>
