  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-500 mt-2">Define camera work, lighting, and production details</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div className="bg-orange-600 h-2 rounded-full transition-all duration-300" style={{ width: '75%' }}></div>
        </div>
      </div>
