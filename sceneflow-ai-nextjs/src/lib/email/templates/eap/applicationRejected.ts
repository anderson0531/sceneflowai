...
export function buildApplicationRejectedEmail(params: {
  ...
  const body = `
    ...
    <p style="margin:0 0 16px;color:#cbd5e1;">Thank you for taking the time to apply to the SceneFlow Early Access Program. After careful review, we're unable to offer you a spot in the current ${EAP_COHORT_SHORT}.</p>
