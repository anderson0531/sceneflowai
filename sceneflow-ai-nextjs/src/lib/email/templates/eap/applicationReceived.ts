...
export function buildApplicationReceivedEmail(params: {
  ...
  const body = `
    ...
    <p style="margin:0 0 16px;color:#cbd5e1;">Thank you for applying to the SceneFlow Early Access Program — ${EAP_COHORT_SHORT}. We've saved your submission and our team will review it shortly.</p>
    ...
    <ul style="margin:12px 0 0;padding-left:20px;color:#cbd5e1;">
      ...
      <li>Keep an eye on your inbox — we aim to respond before September cohort onboarding begins.</li>
    </ul>
  `
