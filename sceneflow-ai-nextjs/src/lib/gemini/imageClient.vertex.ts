 ...
 * - gemini-3.1-flash-image (GA Nano Banana 2) for the fast/Draft tier
 * - gemini-3-pro-image (GA Nano Banana Pro) for the standard/Final tier, with automatic fallback to flash
 *
