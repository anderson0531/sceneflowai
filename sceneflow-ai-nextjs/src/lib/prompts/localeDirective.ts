...
export function localeDirective(
  ...
  const lines = [
    ...
    'synopses, character descriptions and arcs, scene descriptions, dialogue, and',
    'narration. Write natively in that language: use its idiom and register rather',
    'than translating English phrasing word for word.',
    '',
