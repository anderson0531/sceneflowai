...
/**
 * Canonical per-audio-line prompt bundle generated by Scene Direction API.
 * This is consumed by segment generation to avoid repeating one scene-level
 * direction across every segment.
 */
export interface SceneSegmentPromptBundleEntry {
...
export interface SegmentDirection {
   ...
   */
  depthOfField?: string
  /** Concise per-segment direction summary for script cards. */
  segmentDirectionSummary?: string
