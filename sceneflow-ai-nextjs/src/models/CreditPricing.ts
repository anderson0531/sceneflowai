...
export const DEFAULT_CREDIT_PRICING: Omit<CreditPricingCreationAttributes, 'id' | 'created_at' | 'updated_at'>[] = [
  ...
  // Video Generation
  {
    ...
    effective_from: new Date('2025-01-01'),
    effective_to: null,
    notes: 'Gemini Omni Flash (primary) — ~10s clips at Veo Fast pricing tier',
  },
  {
    provider: 'google_vertex',
    category: 'video_generation',
    ...
    model: 'gemini-omni-flash-preview',
    metric: 'per_video_8s',
    credits_per_unit: 188,
    provider_cost_usd: 0.94,
    margin_percent: 50,
    is_active: true,
    effective_from: new Date('2026-07-01'),
    effective_to: null,
    notes: 'Gemini Omni Flash 10s clip (~$0.10/sec)',
  },
  {
    provider: 'google_vertex',
    category: 'video_generation',
    ...
    effective_from: new Date('2025-01-01'),
    effective_to: null,
    notes: 'Premium tier routed to Omni Flash — legacy 4K pricing retained for margin',
  },
