#!/usr/bin/env node
/**
 * Upload the web-encoded BYOK Spanish master to Vercel Blob.
 *
 * Usage:
 *   BLOB_READ_WRITE_TOKEN=... node scripts/upload-byok-spanish-mp4.mjs [path/to/BYOK-Spanish.mp4]
 *
 * Default local path: public/landing/key-features/BYOK-Spanish.mp4
 * Blob pathname: BYOK (Spanish).mp4 (blob root, contentType video/mp4, allowOverwrite)
 *
...
const BLOB_PATH = 'BYOK (Spanish).mp4'
const DEFAULT_LOCAL = join(PROJECT_ROOT, 'public/landing/key-features/BYOK-Spanish.mp4')
