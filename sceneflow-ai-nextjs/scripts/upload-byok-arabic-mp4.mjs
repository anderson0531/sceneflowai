#!/usr/bin/env node
/**
 * Upload a web-encoded BYOK Arabic master to Vercel Blob.
 *
 * Usage:
 *   BLOB_READ_WRITE_TOKEN=... node scripts/upload-byok-arabic-mp4.mjs [path/to/BYOK-Arabic.mp4]
 *
 * Blob pathname: BYOK (Arabic).mp4 (blob root, contentType video/mp4, allowOverwrite)
 *
...
const BLOB_PATH = 'BYOK (Arabic).mp4'
const DEFAULT_LOCAL = join(PROJECT_ROOT, 'public/landing/key-features/BYOK-Arabic.mp4')
