#!/usr/bin/env node
/**
 * Upload a web-encoded BYOK Thai master to Vercel Blob.
 *
 * Usage:
 *   BLOB_READ_WRITE_TOKEN=... node scripts/upload-byok-thai-mp4.mjs [path/to/BYOK-Thai.mp4]
 *
 * Blob pathname: BYOK (Thai).mp4 (blob root, contentType video/mp4, allowOverwrite)
 *
...
const BLOB_PATH = 'BYOK (Thai).mp4'
const DEFAULT_LOCAL = join(PROJECT_ROOT, 'public/landing/key-features/BYOK-Thai.mp4')
