#!/usr/bin/env node
/**
 * Upload a web-encoded BYOK Chinese master to Vercel Blob.
 *
 * Usage:
 *   BLOB_READ_WRITE_TOKEN=... node scripts/upload-byok-chinese-mp4.mjs [path/to/BYOK-Chinese.mp4]
 *
 * Blob pathname: BYOK (Chinese).mp4 (blob root, contentType video/mp4, allowOverwrite)
 *
...
const BLOB_PATH = 'BYOK (Chinese).mp4'
const DEFAULT_LOCAL = join(PROJECT_ROOT, 'public/landing/key-features/BYOK-Chinese.mp4')
