#!/usr/bin/env node
/**
 * Upload a web-encoded BYOK Hindi master to Vercel Blob.
 *
 * Usage:
 *   BLOB_READ_WRITE_TOKEN=... node scripts/upload-byok-hindi-mp4.mjs [path/to/BYOK-Hindi.mp4]
 *
 * Blob pathname: BYOK (Hindi).mp4 (blob root, contentType video/mp4, allowOverwrite)
 *
...
const BLOB_PATH = 'BYOK (Hindi).mp4'
const DEFAULT_LOCAL = join(PROJECT_ROOT, 'public/landing/key-features/BYOK-Hindi.mp4')
